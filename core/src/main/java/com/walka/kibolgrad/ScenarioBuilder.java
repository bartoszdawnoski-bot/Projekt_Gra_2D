...
public class ScenarioBuilder {
    ...
    // Zauważ - nie musimy już podawać Texture!
    public static BattleConfig createOriginalFight() {
        ...
        // Przekazujemy "klub1" - tekstury załadują się same przez HashMape!
        Fighter player = new Fighter(new Vector2(150, 500), new PlayerInput(), playerStats, Team.PLAYERS, "gl", true);
        ...
        player.equipConsumable(1, new Speed(2, 15f));  // Amfetamina
        ...
        Fighter ally1 = new Fighter(new Vector2(400, 800), new AIInput(null), ally1Stats, Team.PLAYERS, "kato", false);
        config.addPlayerTeamMember(ally1);

        FighterStats ally2Stats = new FighterStats(20, 5, 10, 20);
        Fighter ally2 = new Fighter(new Vector2(400, 600), new AIInput(null), ally2Stats, Team.PLAYERS, "zab", false);
        config.addPlayerTeamMember(ally2);

        // --- WROGOWIE ---
        FighterStats enemy1Stats = new FighterStats(5, 20, 5, 10);
        Fighter enemy1 = new Fighter(new Vector2(1000, 800), new AIInput(null), enemy1Stats, Team.ENEMIES, "kfc", false);
        ...
        Fighter enemy3 = new Fighter(new Vector2(1000, 400), new AIInput(null), enemy3Stats, Team.ENEMIES, "chuje", false);
