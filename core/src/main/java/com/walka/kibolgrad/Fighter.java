...
public class Fighter {
    ...
    private float screenWidthEnd = 1920f;

    private float screenHeightStart = 0f;
    private float screenHeightEnd = 1080f;
    ...
    public void update(float delta) {
        ...
        switch (state) {
            ...
            case DODGING: {
                ...
                else hurtBox.set(position.x, position.y, 50f,100f);
        ...
        //rysowanie przeniesionego hitboxa
    ...
    public void takeDamage(float damage, float staminaDamage, float attackerFacingX) {
        ...
        if (state == FighterState.BLOCKING && currentStamina > 0) {
            ...
            float actualStaminaDamage = (damage > stats.attackDamage) ? staminaDamage * 3 : staminaDamage;
